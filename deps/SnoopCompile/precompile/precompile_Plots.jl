...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(RecipesBase.apply_recipe),Dict{Symbol,Any},Type{Val{:spy}},Plot{GRBackend}})
    ...
    Base.precompile(Tuple{typeof(discrete_value!),Axis,Array{Union{Missing, Float64},1}})
