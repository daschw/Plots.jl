...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(Plots._preprocess_barlike),RecipesPipeline.DefaultsDict,Array{Int64,1},Array{Float64,1}})
    ...
    Base.precompile(Tuple{typeof(Plots.gr_draw_minorgrid),Plots.Subplot{Plots.GRBackend},Plots.Axis,Segments{Tuple{Float64,Float64}}})
